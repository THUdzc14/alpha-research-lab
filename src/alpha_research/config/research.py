...
# Notebook 04 established this as the common active
# evaluation start across the original four portfolios.
STRATEGY_EVALUATION_START_DATE = pd.Timestamp("2016-01-07")
